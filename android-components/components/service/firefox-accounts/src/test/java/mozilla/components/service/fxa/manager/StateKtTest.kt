...
class StateKtTest {
    ...
    private fun instantiateAccountState(simpleName: String): AccountState {
        return when (simpleName) {
            ...
            "Authenticating" -> AccountState.Authenticating("https://example.com/oauth-start", "test-state")
    ...
    private fun instantiateEvent(eventClassSimpleName: String): Event {
        return when (eventClassSimpleName) {
            ...
            "StartedOAuthFlow" -> Event.Progress.StartedOAuthFlow("https://example.com/oauth-start", "test-state")
